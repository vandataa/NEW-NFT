...
import { signAndConfirmTransaction, signAndConfirmTransactionFe } from '../utilityfunc.js';
    ...
    axios({
      ...
      .then(async (res) => {
        ...
        if (res.data.success === true) {
          ...
          const ret_result = await signAndConfirmTransactionFe(network, transaction, callback); //flow from here goes to utility func
